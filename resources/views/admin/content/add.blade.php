...
@section('content')
    <div class="layui-fluid larry-wrapper">
        <section class="panel panel-padding">
            <form id="form1" class="layui-form " action="/Admin/content/create" method="post">
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs3">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea id="tags" name="tags" class="layui-textarea"></textarea>
                            </div>
                        </div>
                        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
                            <legend>更多功能</legend>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox" name="criticism" title="允许评论" checked="">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">引用通告</label>
                            <div class="layui-input-block">
                                <textarea name="quote" placeholder="请输入内容 每一行一个引用地址, 用回车隔开" class="layui-textarea"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
