...
(function($){
    ...
    $.fn.tagEditor = function(options, val, blur){
        ...
        return selector.each(function(){
            ...
            var ed = $('<ul '+(o.clickDelete ? 'oncontextmenu="return false;" ' : '')+'class="tag-editor layui-textarea" ></ul>').insertAfter(el);
            ...
            // markup for new tag
            var new_tag = '<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag iconfont icon-biaoqian2"></div><div class="tag-editor-delete"><i></i></div></li>';
